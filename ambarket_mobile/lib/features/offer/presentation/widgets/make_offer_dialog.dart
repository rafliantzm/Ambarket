  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(createOfferControllerProvider, (prev, next) {
      if (next is AsyncError) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Tawaran berhasil dikirim')));
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Harga Asli: ${_currencyFormat.format(widget.originalPrice)}', style: const TextStyle(color: Colors.grey)),
            ...
            ElevatedButton(
              ...
              child: isLoading ? const SizedBox(height: 20, width: 20, child: CircularProgressIndicator(strokeWidth: 2)) : const Text('Kirim Tawaran'),
            ),
            const SizedBox(height: AppSpacing.lg),
          ],
        ),
