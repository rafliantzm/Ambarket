...
class DummyWithdrawalDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<DummyWithdrawalDialog> createState() =>
      _DummyWithdrawalDialogState();
}
...
class _DummyWithdrawalDialogState extends ConsumerState<DummyWithdrawalDialog> {
  ...
  void _submit() async {
    ...
    final amount = CurrencyParser.parse(_amountController.text).toDouble();
  ...
  Widget build(BuildContext context) {
    final isLoading = ref
        .watch(sellerWithdrawalActionControllerProvider)
        .isLoading;
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (value) {
                  ...
                  final numVal = CurrencyParser.parse(value);
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  labelText: 'Nama Bank (Cth: BCA, Mandiri)',
                ),
                validator: (value) =>
