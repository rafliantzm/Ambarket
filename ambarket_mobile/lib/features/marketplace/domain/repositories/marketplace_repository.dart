...
abstract class MarketplaceRepository {
  ...
  // Home Sections
  Future<List<ProductModel>> fetchRecommendedProducts({int limit = 10, int offset = 0});
  Future<List<ProductModel>> fetchLatestProducts({int limit = 10, int offset = 0});
  Future<List<ProductModel>> fetchBestDealProducts({int limit = 10, int offset = 0});
  Future<List<ProductModel>> fetchNearbyProducts(String? location, {int limit = 10, int offset = 0});
  Future<List<ProductModel>> fetchRelatedProducts(String productId, String categoryId, {int limit = 6});
