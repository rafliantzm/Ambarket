...
import 'package:ambarket_mobile/features/profile/presentation/screens/wishlist_screen.dart';
...
void main() {
  group('Profile Features Tests', () {
    testWidgets('ProfileScreen renders loading and then profile data', (WidgetTester tester) async {
    ...
    testWidgets('WishlistScreen renders empty state', (WidgetTester tester) async {
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            myWishlistProductsProvider.overrideWith((ref) => []),
          ],
          child: const MaterialApp(
            home: WishlistScreen(),
          ),
